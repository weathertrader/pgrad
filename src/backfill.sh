...
python ./src/pgrad.py --model_name=gfs --process_name=calc_pgrad --bucket_name=data --batch_mode=$mode
# hrrr
...
python ./src/pgrad.py --model_name=hrrr --process_name=calc_pgrad --bucket_name=data --batch_mode=$mode
# nam 
...
python ./src/pgrad.py --model_name=nam --process_name=calc_pgrad --bucket_name=data --batch_mode=$mode
# plot
